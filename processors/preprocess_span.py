...
from MPNs_Dataset.processors.data_loader import DataProcessor
from MPNs_Dataset.processors.utils_ner import get_entities
...
class CnerProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        """See base class."""
        return self._create_examples(self.read_text(os.path.join(data_dir, "train.char.bmes")), "train")

    def get_dev_examples(self, data_dir):
        """See base class."""
        return self._create_examples(self.read_text(os.path.join(data_dir, "dev.char.bmes")), "dev")

    def get_test_examples(self, data_dir):
        """See base class."""
        return self._create_examples(self.read_text(os.path.join(data_dir, "test.char.bmes")), "test")
...
class CluenerProcessor(DataProcessor):
    ...
    def get_dev_examples(self, data_dir):
        """See base class."""
        return self._create_examples(self.read_text(os.path.join(data_dir, "devel.txt")), "dev")
...
ner_processors = {"cluener": CluenerProcessor}
