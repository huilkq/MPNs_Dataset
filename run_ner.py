...
from MPNs_Dataset.NER.model_ner import BertSpanForNer
from MPNs_Dataset.processors.utils_ner import bert_extract_item, bert_extract_items
from MPNs_Dataset.tools.finetuning_argparse import get_argparse
from MPNs_Dataset.tools.progressbar import ProgressBar
from torch.optim import AdamW
from tools.common import seed_everything
from tools.common import logger

from transformers import AutoTokenizer, AutoConfig, get_linear_schedule_with_warmup
from processors.preprocess_span import convert_examples_to_features
from processors.preprocess_span import ner_processors as processors
from processors.preprocess_span import collate_fn
from MPNs_Dataset.metrics import SpanEntityScore
    ...
    for _ in range(int(args.num_train_epochs)):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if args.local_rank in [-1,
                                   0] and global_step >= 1 * args.logging_steps and global_step % args.logging_steps == 0:
                # Log metrics
                logger.info("\n")
